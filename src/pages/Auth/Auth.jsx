    ...
    return (
        ...
        { !isSignup && <img src={icon} alt='stack overflow' className='login-logo'  width={95}/>}
                ...
                <button type='submit' className='auth-btn'>{ isSignup ? 'Sign up': 'Log in'}</button>
                {
                    isSignup && (
                        <p style={{ color:"#666767", fontSize:"13px" }}>
                            ...
                            <spam style={{ color:"#007ac6" }}> terms of <br/>service </spam> and acknowledge that you have read <br/>and understand our
                            <spam style={{ color:"#007ac6" }}> privacy policy </spam>and 
                            <spam style={{ color:"#007ac6" }}> code of <br/>conduct.</spam>
                        </p>
                    )
                }
            </form>
